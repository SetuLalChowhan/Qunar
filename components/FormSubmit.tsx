...
const FormSubmit: React.FC = () => {
  ...
  const fullNamePlaceholder = useTypingEffect(
    isVisible ? "Type your full name here..." : ""
  );
  const emailPlaceholder = useTypingEffect(
    isVisible ? "Enter your email address..." : ""
  );
  const messagePlaceholder = useTypingEffect(
    isVisible ? "Write your message here..." : ""
  );

  return (
    <form ref={formRef} onSubmit={handleSubmit}>
      <fieldset className="mt-8 space-y-5 inline-block transition-all ease-in-out duration-300">
